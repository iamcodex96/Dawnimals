...
<div class="cabecera mb-4">
    <div class="row">
        ...
        <div class="col-md-1 col-sm-12">
            <a href="{{url('backend/donantes/create')}}" class="btn btn-success float-right" data-toggle="tooltip" data-placement="top"
                title="Agregar donante"> <i class="fa fa-plus"></i> </a>
        </div>
    </div>
</div>
