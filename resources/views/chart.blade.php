...
<div class="container">
    ...
    <div class="card mb-3">
        <div class="card-header">
            <i class="fa fa-area-chart"></i> Donaciones por animal del mes</div>
        <div class="card-body">
    ...
    <div class="card mb-3">
        <div class="card-header">
            <i class="fa fa-area-chart"></i> Donaciones por centro del mes</div>
        <div class="card-body">
    ...
    <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-area-chart"></i> Donaciones por subtipo del mes</div>
            <div class="card-body">
                <canvas id="pieAreaChar" width="100%" height="30"></canvas>
            </div>
            {{-- <div class="card-footer small text-muted">Updated today at @php  echo date('F j, Y', time() ) @endphp</div> --}}
        </div>
...
<script src="{{url( 'js/charts/create-pie-subtipos.js' )}}"></script>
